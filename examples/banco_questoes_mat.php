    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            <a class="nav-link active" href="./banco_questoes_mat.php?id=1">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        ...
        <!-- NOME DA PAGINA -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./simulados.php">Banco de Questões /
          Matemática</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          ...
          <div class="row" style="margin-left: 5px; margin-right: 5px;">
            ...
            <div class="col-md-1">
              <a href="banco_questoes_mat.php?id=<?php echo $res['ID'] ?>">
                <button type="button" class="btn btn-outline-white"
                  style="border-radius: 100%; width: 100%; height: 100%;">
                  <span class="material-symbols-outlined text-white" style="margin-top: 20%; margin-bottom: 20%;">
                    <?php echo $res['ICONE'] ?>
                  </span>
                  <br>
                </button>
    ...
    <div class="container-fluid mt--7">
      ...
      <br><br><br><br><br><br>
      <h3>Conhecimentos
        <?php echo $res['CONHECIMENTOS'] ?>
      </h3>
      <hr>
      <?php
      $result = mysqli_query($mysqli, "SELECT * FROM tb_topicos WHERE ID_MATERIA = $id_url;");
      while ($res = mysqli_fetch_array($result)) { ?>
      <a href="<?php echo $res['PDF'] ?>" style="margin-left: 3%; color: #32325d;"> >
        <?php echo $res['TOPICO'] ?>
      </a>
      <br>
      <br>
