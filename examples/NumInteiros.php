...
if (isset($_GET)) {
  ...
  $result = mysqli_query($mysqli, "SELECT * FROM tb_topicos WHERE ID = $id");
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
              ...
              <a href="../tcc/telainicial.php" class="dropdown-item">
    ...
    <div class="container-fluid mt--7">
      ...
      <div class="row mt-5">
        ...
        <div class="col-xl-7 mb-5 mb-xl-0">
          <div class="card shadow">
            ...
            <div class="table-responsive">
              <iframe id="video" width="100%" height="400" src="<?php echo $dados['VIDEOAULA'] ?>"
            ...
            <div class="card-footer py-4">
              <nav aria-label="...">
                <ul class="pagination justify-content-end mb-0">
                  <li class="page-item " onclick="Depois()"><a class="page-link"> 1 </a></li>
                </ul>
              </nav>
            </div>
          </div>
        ...
        <div class="col-xl-3">
            ...
            <div class="card-body pt-0 pt-md-4">
              <div class="row">
                <div class="col">
                  <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                    ...
                    <div>
                      <span class="heading padding-bottom">1</span>
                      <span class="description">Material </span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="text-center">
                ...
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i>Formado em
          ...
          <div class="card espa"></div>
          <a href="<?php echo $dados['MAPA_MENTAL'] ?>">
            <button href="" type="button" class="btn btn-light" style="width: 100%; height: 11%; color: #525f7f;">
              <div class="d-inline" style="margin-right: 3%;"></div>
              <i class="ni ni-ungroup text-dark" style="margin-right: 15%;"></i> Mapa Mental <div class="d-inline"
                style="margin-left: 50%;"></div>
            </button>
          </a>
          <div class="card espa"></div>
          <a href="#Apoio">
            <button type="button" class="btn btn-light" style="width: 100%; height: 11%; color: #525f7f;">
              <div class="d-inline" style="margin-right: 3%;"></div>
              <i class="ni ni-books text-dark" style="margin-right: 15%;"></i> Material de Apoio <div class="d-inline"
                style="margin-left: 50%;"></div>
            </button>
          </a>
        </div>
      ...
      <div class="row mt-5">
        ...
        <div class="col-xl-10 mb-5 mb-xl-0">
          <h3 id="Apoio" class="mb-0  text-uppercase d-none d-lg-inline-block">Material de apoio</h3>
          <hr>
        </div>
        <div class="col-xl-1 mb-5 mb-xl-0"></div>
      </div>
          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Descrição da aula:</h3>
                </div>
              </div>
            </div>
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    <th scope="col">Acompanhe a aula com uma ajuda.</th>
                  </tr>
                </thead>
                <tbody>
                  <th class="">
                    <div class="texto" style="margin-left: 2%; margin-right: 2%; text-align: justify;">
                      <?php echo $dados['MAT_APOIO'] ?>
                      <br>
                    </div>
                  </th>
                </tbody>
