...
$result = mysqli_query($mysqli, "SELECT * FROM tb_corrigirredacoes WHERE ID_USU = $id_usu");
?>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        ...
        <!-- NOME DA PAGINA -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./simulados.php">Redação</a>
      ...
      <div class="container-fluid">
        <div class="header-body">
          ...
          <ul class="nav nav-pills nav-justified">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="./redacao.php">Temas</a>
            </li>
            <li class="nav-item ">
    ...
    <div class="container-fluid mt--7">
      ...
      <div class="row">
        <div class="col-xl-6">
          <a href="#" style="color: #525f7f;">
            <div class="card card-stats mb-4 mb-xl-0 shadow p-3 bg-body rounded ">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-2">
                    <div class="avatar rounded-circle mr-3">
                      <img src="../assets/img/theme/minhas_redacoes.png" style="width: 100%; height: 100%;">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <h5 class=" h6 card-title text-uppercase text-white mb-0"
                      style="background-color: #acacac; width: 25%;  border-radius: 10px; ">
                      <center>Em analise</center>
                    </h5>
      ...
      <?php $resultII = mysqli_query($mysqli, "SELECT * FROM tb_redacaocorrigida WHERE ID_USU = $id_usu"); 
      while ($resII = mysqli_fetch_array($resultII)) { ?>
      <div class="row">
        <div class="col-xl-6">
          <a href="correcao_redacao.php?id_red=<?php echo $resII['ID']?>" style="color: #525f7f;">
            <div class="card card-stats mb-4 mb-xl-0 shadow p-3 bg-body rounded ">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-2">
                    <div class="avatar rounded-circle mr-3">
                      <img src="..\assets\img\theme\Ansiedade.jpg" style="width: 100%; height: 100%;">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <h5 class=" h6 card-title text-uppercase text-white mb-0"
                      style="background-color: #76b276; width: 25%;  border-radius: 10px; ">
                      <center>Corrigido</center>
                    </h5>
                    <span class="h4 font-weight-bold mb-0"><?php echo $resII['TEMA'] ?></span>
                  </div>
                </div>
              </div>
            </div>
