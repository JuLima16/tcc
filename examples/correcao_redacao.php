...
$result = mysqli_query($mysqli, "SELECT * FROM tb_redacaocorrigida WHERE ID = $id_red");
    ...
    <div class="container-fluid mt--7">
      ...
      <div class="row">
          <div class="col-xl-1"></div>
                  <div class="col-xl-8">
                    <center>
                    <img src="../assets/img/theme/redacao.png" alt="" width="70%" height="110%" >
                    </center>
                  </div>                  
      ...
      <div class="row">
          <div class="col-xl-2"></div>
                  <div class="col-xl-8">
                  <a class="h4 mb-0  text-uppercase d-none d-lg-inline-block" >Correção da Redação</a>
            <br>
                  </div>                  
          <div class="col-xl-2"></div>
      </div>
